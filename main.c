...
int main(int argc, char *argv[])
{
    ...
    while ((arg=getopt(argc,argv,"f:m:Mhec"))!= -1)
    {
        ...
        case 'h':
            ...
            printf("содежащего данные, полученные с датчика температуры.\n");
            printf("Файл должен лежать в той же папке, где лежит файл программы.\n");
            printf("Без дополнительных парамтеров программа выведет данные за год.\n\n");
            printf("Значения температуры ниже -99 и выше 99 градусов не учитываюся и считаются ошибочными.\n\n");
            ...
            printf(" -M                       выводится статистика за все месяцы\n");
